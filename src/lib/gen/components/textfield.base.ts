...
import { TextField as ITextField } from "../response.js";
...
export class TextFieldBaseImpl extends Component<ITextField> {
     ...
     */
    onAppPrivateCommand(listener: ListenerName, props?: { [k: string]: unknown; }) { return this.setListener("onAppPrivateCommand", listener, props); }
    /**
     ...
     */
    onEditingComplete(listener: ListenerName, props?: { [k: string]: unknown; }) { return this.setListener("onEditingComplete", listener, props); }
    /**
     * Callback when the user tells he is done editing the text field.
     */
    onSubmitted(listener: ListenerName, props?: { [k: string]: unknown; }) { return this.setListener("onSubmitted", listener, props); }
    /**
     * Callback when the user taps on the text field.
     */
    onTap(listener: ListenerName, props?: { [k: string]: unknown; }) { return this.setListener("onTap", listener, props); }
    /**
