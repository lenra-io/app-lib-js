...
import { BorderRadius, BoxShadow, BoxShape, LenraComponent } from '../gen/response.js';
import { Component } from './component.js';


import { border, borderRadius, colors, padding } from '../styles/index.js';
...
export function Container<T extends LenraComponent>(child?: Component<T> | T): ContainerImpl {
  ...
  if (child) el.child(Component.normalize(child));
  return el;
}
...
export class ContainerImpl extends ContainerBaseImpl {
  ...
  child<T extends LenraComponent>(child: T)
